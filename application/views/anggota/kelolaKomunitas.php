...
<ul class="breadcrumb">
    <li>Komunitas</li>
    <li class="active"><a href="<?= base_url('anggota/Komunitas/kelolaKomunitas'); ?>">Kelola Status Komunitas</a></li>
</ul>
<!-- END BREADCRUMB -->
...
<div class="page-content-wrap">
        ...
        <div class="col-md-6">
            <div class="panel panel-default">
                <div class="panel-body">
                    <div class="row">
                        <p>Cari Komunitas</p>
                        <form action="<?= base_url('anggota/Komunitas/cariKomunitas'); ?>" method="post">
                            <div class="col-md-12">
    ...
    <div class="modal animated zoomIn" id="message-box-ubah-komunitas" tabindex="-1" role="dialog" aria-labelledby="defModalHead" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="<?= base_url('anggota/Komunitas/setUpdateKomunitas'); ?>" class="form-horizontal" id="ubah-anggota-validate" method="post" enctype="multipart/form-data">
    ...
    <div class="modal animated zoomIn" id="message-box-ubah-gambar-komunitas" tabindex="-1" role="dialog" aria-labelledby="defModalHead" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="<?= base_url('anggota/Komunitas/setUpdateFotoKomunitas'); ?>" class="form-horizontal" id="ubah-anggota-validate" method="post" enctype="multipart/form-data">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
                        <h4 class="modal-title" id="defModalHead">Ubah Komunitas</h4>
                    </div>
