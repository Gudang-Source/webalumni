        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <p>Formulir Permohonan Komunitas Baru IKASMA3BDG.</p>

                    <div class="form-group">
                        <form action="<?= base_url('anggota/Komunitas/tambahCalonKomunitas'); ?>" class="form-horizontal" id="form-tambah-komunitas-validate" method="post" enctype="multipart/form-data">
                            <div class="panel-body">
                                <div class="form-group">
