...
<ul class="breadcrumb">
    <li>Komunitas</li>
    <li class="active"><a href="<?= base_url('anggota/Komunitas/komunitasNonaktif'); ?>">Komunitas Nonaktif</a></li>
</ul>
<!-- END BREADCRUMB -->
...
<div class="page-content-wrap">
    ...
    <div class="row">
        <div class="col-md-6">
            <a href="<?= base_url('anggota/Komunitas'); ?>" class="btn btn-info"></b>Komunitas Akitf</a>
            <br>
            <br>
        </div>
    </div>
            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    ...
                    <form action="<?= base_url('anggota/Komunitas/cariStatusKomunitasNonaktif'); ?>" method="post">
                        ...
                        <div class="form-group">
                            <div class="col-md-2">
                                <a href="<?= base_url('anggota/Komunitas/komunitasNonaktif'); ?>" class="btn btn-primary">Reset Pencarian</a>
                            </div>
                        </div>
                    </form>
                </div>
                                    ...
                                    <div class="contact-info">
                                        ...
                                        <div class="panel-body">
                                            <div class="contact-info">
                                                ...
                                                <p><i class="fa fa-user" aria-hidden="true"></i> <strong>Pengupload Komunitas</strong><br><h5><?= $A->username; ?></h5></p>
    ...
    <div class="message-box message-box-danger animated zoomIn" data-sound="alert" id="message-box-delete-komunitas">
        ...
        <div class="mb-container">
            <div class="mb-middle">
                ...
                <form action="<?= base_url('anggota/Komunitas/batalkanPermohonanKomunitas'); ?>" class="form-horizontal" method="post">
    ...
    <script>
        ...
        $.post("<?= base_url('anggota/Komunitas/KomunitasJSON/') ?>", {
                id: idKomunitasHapus
            },
            function(data) {
