            ...
            <div class="panel panel-default">
                <div class="panel-body profile">
                    ...
                    <div class="profile-controls">
                        <a class="profile-control-left btn-ubah-anggota" title="Ubah" id="<?= $A->id_anggota; ?>"
                            data-toggle="modal" data-target="#ubahAnggota"><span class="fa fa-edit"></span></a>
                        <a class="profile-control-right btn-hapus-anggota" title="Hapus" id="<?= $A->id_anggota; ?>"
                            data-toggle="modal" data-target="#message-box-delete-anggota"><span
...
<!-- MODAL UBAH ANGGOTA -->
<div class="modal animated zoomIn" id="ubahAnggota" tabindex="-1" role="dialog" aria-labelledby="defModalHead"
    aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="<?= base_url('admin/Anggota/setUpdateAnggota'); ?>" class="form-horizontal"
                id="ubah-anggota-validate" method="post">
                        ...
                        <div class="panel-body tab-content">
                            ...
                            <div class="tab-pane active" id="tab-data-diri">
                                ...
                                <div class="panel-body" style="z-index: 2000;">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" name="panggilanAlias"
                                                id="panggilanAlias" placeholder="Nama Panggilan / Alias" required />
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-3">
                                            <input type="text" class="form-control datepicker" id="tanggalLahir"
                                                name="tanggalLahir" placeholder="Tanggal Lahir" required />
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" id="golonganDarah"
                                                name="golonganDarah" placeholder="Golongan Darah" required />
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <input type="text" class="form-control" id="teleponAlternatif"
                                                name="teleponAlternatif" placeholder="No. Telepon Alternatif" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                            ...
                            <div class="tab-pane" id="tab-domisili">
                                ...
                                <div class="panel-body" style="z-index: 2000">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" id="kabupatenKota"
                                                name="kabupatenKota" placeholder="Kabupaten / Kota" required />
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <textarea rows="5" class="form-control" id="alamat" name="alamat"
                            ...
                            <div class="tab-pane" id="tab-profesi">
                                ...
                                <div class="panel-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" id="pendidikanTerakhir"
                                                name="pendidikanTerakhir" placeholder="Pendidikan Terakhir" required />
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <select class="validate[required] select form-control" name="statusBekerja"
                                                id="statusBekerja" onchange="statusBekerjaChange()">
                                                <option value="">Pilih</option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" id="bidangIndustri" class="form-control"
                                                name="bidangIndustri" placeholder="Bidang Industri" />
                                        </div>
                                    </div>
                            ...
                            <div class="tab-pane" id="tab-info-program">
                                ...
                                <div class="panel-body" style="z-index: 2000">
                                    <div class="form-group">
                                        <div class="col-md-9">
                                            <input type="checkbox" id="infoProgram1" name="infoProgram1"
                                                class="icheckbox" /> <label class="check">Sosial Pendidikan</label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-9">
                                            <label class="check"><input type="checkbox" id="infoProgram2"
                                                    name="infoProgram2" class="icheckbox" checked="" /> Sosial
                                                Kemanusiaan</label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-9">
                                            <label class="check"><input type="checkbox" id="infoProgram3"
                                                    name="infoProgram3" class="icheckbox" /> Pengembangan Sarana
                                                Prasarana</label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-9">
                                            <label class="check"><input type="checkbox" id="infoProgram4"
                                                    name="infoProgram4" class="icheckbox" /> Silaturahim &
                                                Kebersamaan</label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-9">
                                            <label class="check"><input type="checkbox" id="infoProgram5"
                                                    name="infoProgram5" class="icheckbox" /> Penawaran Sponsorship /
                                                Donasi</label>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="tab-pane" id="tab-keanggotaan">
                                ...
                                <div class="panel-body" style="z-index: 2000">
                                    <div class="form-group">
                                        <div class="col-md-9">
                                            <label class="check control-label"><input type="checkbox" class="icheckbox"
                                                    id="keanggotaan1" name="keanggotaan1" /> Support</label>
                                        </div>
                                        <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-9">
                                            <label class="check control-label"><input type="checkbox" class="icheckbox"
                                                    id="keanggotaan2" name="keanggotaan2" /> Loyalist</label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <input type="number" class="form-control" id="iuranSukarela"
                                                name="iuranSukarela"
                                                placeholder="Masukkan jumlah uang iuran sukarela" />
                                        </div>
                                    </div>
                                </div>
