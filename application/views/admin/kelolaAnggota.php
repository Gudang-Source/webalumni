                                ...
                                <div class="panel-body tab-content">
                                    ...
                                    <div class="tab-pane" id="tab-info-program">
                                        ...
                                        <div class="panel-body" style="z-index: 2000">
                                            ...
                                            <div class="form-group">
                                                <div class="col-md-9">
                                                    <label class="check"><input type="checkbox" id="infoProgram2" name="infoProgram2" class="icheckbox" checked="" /> Sosial Kemanusiaan</label>
                                                </div>
                                            </div>
                                            
                                            <div class="form-group">
                                                <div class="col-md-9">
                                                    <label class="check"><input type="checkbox" id="infoProgram3" name="infoProgram3" class="icheckbox"/> Pengembangan Sarana Prasarana</label>
                                                </div>
                                            </div>
                                            
                                            <div class="form-group">
                                                <div class="col-md-9">
                                                    <label class="check"><input type="checkbox" id="infoProgram4" name="infoProgram4" class="icheckbox" /> Silaturahim & Kebersamaan</label>
                                                </div>
                                            </div>
                                            
                                            <div class="form-group">
                                                <div class="col-md-9">
                                                    <label class="check"><input type="checkbox" id="infoProgram5" name="infoProgram5" class="icheckbox" /> Penawaran Sponsorship / Donasi</label>
                                                </div>
                                            </div>
                                        </div>
                ...
                <div class="mb-middle">
                    ...
                    <form action="<?= base_url('admin/Anggota/hapusAnggota'); ?>" class="form-horizontal" method="post">
                        <div class="mb-content">
                            <div class="panel-body">
                                <p>Anda yakin akan menghapus sebagai keanggotaan IKASMA3BDG dengan identitas Anggota sebagai berikut :</p>
