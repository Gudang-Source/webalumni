<!-- START BREADCRUMB -->
<ul class="breadcrumb">
    <li><a href="<?= base_url('admin/forumBisnis'); ?>">Forum Bisnis</a></li>
    <li class="active"><a href="<?= base_url('admin/ForumBisnis/kelolaJenisBisnis'); ?>">Kelola Jenis Bisnis</a></li>
</ul>
<!-- END BREADCRUMB -->
...
<div class="message-box message-box-danger animated zoomIn" data-sound="alert" id="hapusJenisBisnis">
    ...
    <div class="mb-container">
        <div class="mb-middle">
            ...
            <form action="<?= base_url('admin/ForumBisnis/setDeleteJenisBisnis'); ?>" class="form-horizontal" method="post">
