                    ...
                    <div class="panel-body tab-content">
                        ...
                        <div class="tab-pane active" id="tab-data-diri">
                            <div class="pull-right">
                                <button type="button" class="btn btn-info btn-data-diri" data-toggle="modal" data-target="#modal_data_diri" id="<?= $anggota[0]->id_anggota; ?>">
                                    <span>
                        ...
                        <div class="tab-pane" id="tab-domisili">
                            <div class="pull-right">
                                <button type="button" class="btn btn-info btn-domisili" data-toggle="modal" data-target="#modal_domisili" id="<?= $anggota[0]->id_anggota; ?>">
                                    <span>
                                    <i class="fa fa-pencil"></i> Ubah
                                    </span>
                                </button>
                        ...
                        <div class="tab-pane" id="tab-profesi">
                            <div class="pull-right">
                                <button type="button" class="btn btn-info btn-profesi" data-toggle="modal" data-target="#modal_profesi" id="<?= $anggota[0]->id_anggota; ?>">
                                    <span>
                                    <i class="fa fa-pencil"></i> Ubah
                                    </span>
                                </button>
                        ...
                        <div class="tab-pane" id="tab-info-program">
                            <div class="pull-right">
                                <button type="button" class="btn btn-info btn-info-program" data-toggle="modal" data-target="#modal_info_program" id="<?= $anggota[0]->id_anggota; ?>">
                                    <span>
                                    <i class="fa fa-pencil"></i> Ubah
                                    </span>
                                </button>
                        ...
                        <div class="tab-pane" id="tab-keanggotaan">
                            <div class="pull-right">
                                <button type="button" class="btn btn-info btn-keanggotaan" data-toggle="modal" data-target="#modal_keanggotaan" id="<?= $anggota[0]->id_anggota; ?>">
                                    <span>
                                    <i class="fa fa-pencil"></i> Ubah
                                    </span>
                                </button>
