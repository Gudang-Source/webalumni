            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    ...
                    <form action="<?= base_url('admin/Komunitas/cariStatusKomunitas'); ?>" method="post">
                        ...
                        <div class="form-group">
                            <div class="col-md-2">
                                <a href="<?= base_url('admin/Komunitas/kelolaStatusKomunitas'); ?>" class="btn btn-primary">Reset Search</a>
                            </div>
                        </div>
                    </form>
                </div>
        ...
        <div class="col-md-4    ">
            ...
            <div class="panel panel-default">
                <div class="panel-body profile">
                    ...
                    <div class="panel-body">
                        <div class="contact-info">
                                <p><i class="fa fa-link" aria-hidden="true"></i> <strong>Link Komunitas</strong><br><h5><a href=""><?= $A->tautat_komunitas; ?></a></h5></p>
                                    
                                    <?php if ($A->sifat_komunitas == "Publik") { ?>
                                <p><i class="fa fa-eye" aria-hidden="true"></i> <strong> <?= $A->sifat_komunitas ?> </strong><br><h5>Semua orang bisa menemukan grup ini.</h5></p>
                                    <?php } else { ?>
                                <p><i class="fa fa-eye" aria-hidden="true"></i> <strong>Private </strong><br><h5>Tidak semua orang bisa menemukan grup ini.</h5></p>
                                    <?php } ?>
