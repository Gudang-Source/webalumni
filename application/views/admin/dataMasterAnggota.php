...
<ul class="breadcrumb">
    <li>Anggota</li>
    <li class="active"><a href="<?= base_url('admin/Anggota/tambahDataAnggotaMaster'); ?>">Tambah Data Anggota Master</a></li>
</ul>
<!-- END BREADCRUMB -->
                            ...
                            <table class="table table-bordered table-striped table-actions datatable">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><img src="<?php echo base_url('uploads/no-image.jpg'); ?>" width="70" style="height: 60px;" alt="Default Image" title="Default Image"></td>
                                        <?php } else { ?>
                                        <td><img src="<?php echo base_url('uploads/'.$data->nama_foto); ?>" width="70" style="height: 60px;" alt="<?= $data->nama_lengkap; ?>" title="<?= $data->nama_lengkap; ?>"></td>
                                        <?php } ?>
