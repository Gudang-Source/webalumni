<div class="login-container">
    ...
    <div class="login-box animated fadeInDown">
        ...
        <div class="login-body">
            ...
            <div class="login-title"><strong>Selamat Datang</strong>, Mohon isi formulir dibawah ini untuk mendaftar menjadi anggota IKASMA3BDG</div>
        ...
        <div class="login-footer">
            <div class="pull-left">
                &copy; 2018 <a href="<?= base_url(); ?>" title="IKASMA3BDG">IKASMA3BDG</a>
            </div>
        </div>
    </div>    
