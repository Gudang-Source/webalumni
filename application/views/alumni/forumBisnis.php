        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-body">
                    ...
                    <a class="btn btn-success" href="<?= base_url('alumni/ForumBisnis/tambahCalonForbis'); ?>">
            ...
            <div class="panel panel-default">
                <div class="panel-body profile">
                    ...
                    <div class="profile-controls">
                        <a class="profile-control-left btn-ubah-forbis" title="Ubah" id="<?= $A->id_forbis; ?>"
                            data-toggle="modal" data-target="#ubahForbis"><span class="fa fa-edit"></span></a>
                        <a class="profile-control-right btn-hapus-forbis" title="Hapus" id="<?= $A->id_forbis; ?>"
                            data-toggle="modal" data-target="#hapusForbis"><span class="fa fa-trash-o"></span></a>
                    </div>
...
<div class="modal animated zoomIn" id="ubahForbis" tabindex="-1" role="dialog" aria-labelledby="defModalHead"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="<?= base_url('anggota/ForumBisnis/setUpdateForbis'); ?>" class="form-horizontal"
...
<div class="message-box message-box-danger animated zoomIn" data-sound="alert" id="hapusForbis">
    ...
    <div class="mb-container">
        <div class="mb-middle">
            ...
            <form action="<?= base_url('anggota/ForumBisnis/setDeleteForumBisnis'); ?>" class="form-horizontal"
                method="post">
