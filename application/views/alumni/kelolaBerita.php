...
<div class="page-content-wrap">
    ...
    <div class="row">
        <div class="col-md-12">
            <a href="<?= base_url('alumni/Berita/formTambahCalonBerita'); ?>" class="btn btn-success" style="margin-bottom: 15px;"><b>&plus;</b> Tambah Berita</a>
            <a href="<?= base_url('alumni/Berita/beritaNonaktif'); ?>" class="btn btn-info" style="margin-bottom: 15px;">Berita Nonaktif</a>
            <br>
            <div class="panel panel-default">
                <div class="panel-body">
                    <p>Cari Berita</p>
                    <form action="<?= base_url('alumni/Berita/cariBerita'); ?>" method="post">
                        ...
                        <div class="form-group">
                            <div class="col-md-2">
                                <a href="<?= base_url('alumni/Berita'); ?>" class="btn btn-primary">Reset Pencarian</a>
                            </div>
                        </div>
                    </form>
                </div>
...
<div class="modal animated zoomIn" id="message-box-ubah-berita" tabindex="-1" role="dialog" aria-labelledby="defModalHead" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="<?= base_url('alumni/Berita/setUpdateBerita'); ?>" class="form-horizontal" id="form-ubah-berita-validate" method="post" enctype="multipart/form-data">
...
<div class="modal animated zoomIn" id="message-box-ubah-foto" tabindex="-1" role="dialog" aria-labelledby="defModalHead" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="<?= base_url('alumni/Berita/setUpdateFoto'); ?>" class="form-horizontal" id="form-ubah-berita-validate" method="post" enctype="multipart/form-data">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
