    ...
    <div class="page-container animated fadeIn page-navigation-top-fixed">
        ...
        <div class="page-sidebar page-sidebar-fixed scroll">
            ...
            <ul class="x-navigation">
                <li class="xn-logo">
                    <a href="<?= base_url('anggota'); ?>">IKASMA3BDG</a>
                ...
                <li class="hidden">
                    <a href="<?= base_url('anggota/Forbis'); ?>"><span class="glyphicon glyphicon-file"></span> <span
                ...
                <?php } ?>
                <li>
                    <a href="<?= base_url('anggota/Pengaturan'); ?>"><span class="glyphicon glyphicon-cog"></span> <span
