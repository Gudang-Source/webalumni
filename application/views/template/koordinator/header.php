    ...
    <div class="page-container animated fadeIn page-navigation-top-fixed">
        ...
        <div class="page-sidebar page-sidebar-fixed scroll">
            ...
            <ul class="x-navigation">
                ...
                <li>
                    <a href="<?php echo base_url('koordinator') ?>"><span class="fa fa-desktop"></span> <span class="xn-text">Beranda</span></a>
                </li>
                <li>
                    <a href="<?php echo base_url('koordinator/profile') ?>"><span class="glyphicon glyphicon-user"></span>
                        <span class="xn-text">Profil</span></a>
                </li>
                <li class="xn-openable">
                    <a href="#"><span class="fa fa-users"></span> <span class="xn-text">Anggota</span></a>
                    <ul>
                        <li><a href="<?php echo base_url('koordinator/anggota') ?>"><span class="fa fa-user"></span> Kelola
                                Calon Anggota</a></li>
                        <li><a href="<?php echo base_url('koordinator/anggota/kelolaAnggota') ?>"><span class="fa fa-users"></span> Kelola Anggota </a></li>
                        <li><a href="<?php echo base_url('koordinator/anggota/kelolaPemulihanAnggota') ?>"><span class="fa fa-users"></span> Kelola Pemulihan Anggota </a></li>
                        <!-- <li><a href="<?php echo base_url('koordinator/anggota/dataMaster') ?>"><span class="fa fa-plus"></span> Data Master</a></li> -->
                    </ul>
                </li>
                ...
                <li class="xn-openable">
                    ...
                    <ul>
                        ...
                        <li><a href="<?= base_url('koordinator/ForumBisnis'); ?>"><span class="fa fa-bullhorn"></span> <span class="xn-text">Kelola Forum Bisnis</span></a></li>
                ...
                <li class="xn-openable">
                    ...
                    <ul>
                        <li><a href="<?= base_url('koordinator/Komunitas'); ?>"><span class="fa fa-cube"></span> <span class="xn-text">Kelola Komunitas Baru</span></a></li>
                        <li><a href="<?= base_url('koordinator/Komunitas/kelolaStatusKomunitas'); ?>"><span class="fa fa-cubes"></span> <span class="xn-text">Kelola Status
                                    Komunitas</span></a>
                        </li>
                    </ul>
                </li>
