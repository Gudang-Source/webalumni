...
<div class="page-content-wrap">
    ...
    <div class="row">
        <div class="col-md-3">
            ...
            <a class="btn btn-primary" href="<?= base_url('koordinator/anggota/kelolaAnggota'); ?>"><span>&larr;</span> Kembali</a>
                    ...
                    <div class="modal animated zoomIn" id="modal_info_program" tabindex="-1" role="dialog" aria-labelledby="defModalHead" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <form action="<?= base_url('koordinator/Profile/setUpdateInfoProgram'); ?>" id="info-program-validate" class="form-horizontal" method="post">
                                    <div class="modal-body">
                                        <div class="form-group hidden">
                                            <div class="col-md-9">
                    ...
                    <div class="modal animated zoomIn" id="modal_keanggotaan" tabindex="-1" role="dialog" aria-labelledby="defModalHead" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <form action="<?= base_url('koordinator/Profile/setUpdateKeanggotaan'); ?>" id="keanggotaan-validate" class="form-horizontal" method="post">
                                    <div class="modal-body">
                                        <div class="form-group hidden">
                                            <div class="col-md-9">
