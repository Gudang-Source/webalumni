...
<ul class="breadcrumb">
    <li>Komunitas</li>
    <li class="active"><a href="<?= base_url('koordinator/Komunitas'); ?>">Kelola Komunitas</li></a>
</ul>
<!-- END BREADCRUMB -->
            ...
            <div class="panel panel-default tabs">
                ...
                <div class="panel-body tab-content">
                                        ...
                                        <tbody>
                                            ...
                                            <tr id="trow_1">
                                                ...
                                                <td><img src="<?= base_url('uploads/content/komunitas/' . $CA->logo_komunitas); ?>"
                                                        alt="<?= $CA->nama_komunitas; ?>"
                                                        title="<?= $CA->nama_komunitas; ?>" width="80" height="80" />
                                                </td>
                                                <?php } ?>
                    ...
                    <div class="tab-pane" id="tab-second">
                        ...
                        <div class="form-group">
                            <form action="<?= base_url('koordinator/Komunitas/tambahCalonKomunitas'); ?>"
                                class="form-horizontal" id="form-tambah-komunitas-validate" method="post"
                                ...
                                <div class="panel-body">
                                    ...
                                    <input type="hidden" class="form-control" name="idPengupload"
                                        value="<?= $info[0]->id_user ?>">
                                    <div class="panel-body">
                                        <div class="form-group">
                                            <label class="col-md-2 control-label">Nama Komunitas</label>
                                            <div class="col-md-8">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <input type="text" class="form-control" name="tautatKomunitas"
                                                    placeholder="Tautan Komunitas/Link Website Komunitas" required
                                                    clear />
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <textarea class="form-control" name="deskKomunitas"
                                                    placeholder="Deskripsi Komunitas" rows="4" cols="50"></textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <select name="sifatKomunitas"
                                                    class="select form-control validate[required]">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <input type="number" class="form-control" name="anggotaKomunitas"
                                                    placeholder="Perkiraan Jumlah anggota aktif pada komunitas" required
                                                    clear />
                                            </div>
                                        </div>
...
<div class="message-box animated zoomIn" data-sound="alert" id="message-box-terima">
    ...
    <div class="mb-container">
        <div class="mb-middle">
            ...
            <form action="<?= base_url('koordinator/Komunitas/aktivasiCalonKomunitas'); ?>" class="form-horizontal"
                method="post">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group hidden">
                            <div class="col-md-12">
                                ...
                                <input type="text" class="form-control" name="statKomunitas" id="statKomunitas"
                                    value="1">
                            </div>
                        </div>
...
<div class="message-box message-box-danger animated zoomIn" data-sound="alert" id="message-box-tolak">
    ...
    <div class="mb-container">
        <div class="mb-middle">
            ...
            <form action="<?= base_url('koordinator/Komunitas/tolakCalonKomunitas'); ?>" class="form-horizontal"
                method="post">
                <div class="mb-content">
                    <div class="panel-body">
