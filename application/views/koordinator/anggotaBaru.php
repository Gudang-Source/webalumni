            ...
            <div class="panel panel-default tabs">
                ...
                <div class="panel-body tab-content">
                    ...
                    <div class="tab-pane" id="tab-second">
                        ...
                        <div class="form-group">
                            <form action="<?= base_url('koordinator/Anggota/tambahCalonAnggota'); ?>"
                                class="form-horizontal" id="form-tambah-anggota-validate" method="post"
                    ...
                    <div class="tab-pane" id="tab-three">
                        ...
                        <div class="form-group">
                            ...
                            <form action="<?= base_url('koordinator/Anggota/uploadGambar'); ?>" method="post"
...
<div class="message-box animated zoomIn" data-sound="alert" id="message-box-terima" style="margin-top: -100px;">
    ...
    <div class="mb-container">
        <div class="mb-middle">
            ...
            <form action="<?= base_url('koordinator/Anggota/aktivasiCalonAnggota'); ?>" class="form-horizontal"
                method="post">
...
<div class="message-box message-box-danger animated zoomIn" data-sound="alert" id="message-box-tolak">
    ...
    <div class="mb-container">
        <div class="mb-middle">
            ...
            <form action="<?= base_url('koordinator/Anggota/tolakCalonAnggota'); ?>" class="form-horizontal"
                method="post">
                <div class="mb-content">
                    <div class="panel-body">
