...
<ul class="breadcrumb">
    <li>Berita</li>
    <li class="active"><a href="<?= base_url('koordinator/Berita/kelolaBerita'); ?>">Kelola Berita Aktif</a></li>
</ul>
<!-- END BREADCRUMB -->
        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-body">
                    <p>Cari Berita</p>
                    <form action="<?= base_url('koordinator/Berita/cariBerita'); ?>" method="post">
                        ...
                        <div class="form-group">
                            <div class="col-md-2">
                                <a href="<?= base_url('koordinator/Berita/kelolaBerita'); ?>" class="btn btn-primary">Reset Pencarian</a>
                            </div>
                        </div>
                    </form>
                </div>
...
<div class="modal animated zoomIn" id="message-box-ubah-berita" tabindex="-1" role="dialog" aria-labelledby="defModalHead" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="<?= base_url('koordinator/Berita/setUpdateBerita'); ?>" class="form-horizontal" id="form-ubah-berita-validate" method="post" enctype="multipart/form-data">
...
<div class="modal animated zoomIn" id="message-box-ubah-foto" tabindex="-1" role="dialog" aria-labelledby="defModalHead" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="<?= base_url('koordinator/Berita/setUpdateFoto'); ?>" class="form-horizontal" id="form-ubah-berita-validate" method="post" enctype="multipart/form-data">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8" style="margin-left: 10px; margin-top: 12px;">
                        ...
                        <input type="hidden" class="form-control" id="ubahFotoBerita" name="ubahFotoBerita" />
...
<div class="message-box message-box-danger animated zoomIn" data-sound="alert" id="message-box-hapus-berita">
    ...
    <div class="mb-container">
        <div class="mb-middle">
            ...
            <form action="<?= base_url('koordinator/Berita/hapusBerita'); ?>" class="form-horizontal" method="post">
                ...
                <div class="mb-footer">
                    <div class="pull-right">
                        ...
                        <a href="<?= base_url('koordinator/Berita/kelolaBerita'); ?>" class="btn btn-default btn-lg">Batal</a>
                    </div>
                </div>
            </form>
        </div>
