            ...
            <div class="panel panel-default">
                <div class="panel-body profile">
                    ...
                    <div class="profile-controls">
                        ...
                        <a class="profile-control-right btn-hapus-anggota" title="Hapus" id="<?= $A->id_anggota; ?>" data-toggle="modal" data-target="#message-box-hapus-anggota"><span class="fa fa-trash-o"></span></a>
                    </div>
                </div>
                <div class="panel-body">
                    <div class="contact-info">
						<?php if ($A->no_telp == null) { ?>
                ...
                <div class="panel-footer text-center">
                    <!-- <button class="btn btn-info btn-rounded btn-block" id="<?= $A->id_anggota; ?>" title="Lihat" data-toggle="modal" data-target="#modal_large">Lihat</button> -->
                    <button class="btn btn-info btn-rounded btn-block" id="<?= $A->id_anggota; ?>" title="Lihat">Lihat</button>
                </div>
            </div>
            <!-- END CONTACT ITEM -->
        </div>
...
<!-- MODAL IN -->
<div class="modal animated zoomIn" id="modal_large" tabindex="-1" role="dialog" aria-labelledby="largeModalHead" aria-hidden="true">
                                ...
                                <div class="panel-body tab-content">
                                    ...
                                    <!-- <div class="tab-pane" id="tab-info-program">
                                        ...
                                        <div class="panel-body" style="z-index: 2000">
                                            <div class="form-group">
                                                <div class="col-md-9">
                                                    <label class="check"><input type="checkbox" id="infoProgram1" name="infoProgram1" class="icheckbox" required /> Sosial Pendidikan *</label>
                                                </div>
                                            </div>
                                            
                                            <div class="form-group">
                                                <div class="col-md-9">
                                                    <label class="check"><input type="checkbox" id="infoProgram2" name="infoProgram2" class="icheckbox" required /> Sosial Kemanusiaan *</label>
                                                </div>
                                            </div>
                                            
                                            <div class="form-group">
                                                <div class="col-md-9">
                                                    <label class="check"><input type="checkbox" id="infoProgram3" name="infoProgram3" class="icheckbox" required /> Pengembangan Sarana Prasarana *</label>
                                                </div>
                                            </div>
                                            
                                            <div class="form-group">
                                                <div class="col-md-9">
                                                    <label class="check"><input type="checkbox" id="infoProgram4" name="infoProgram4" class="icheckbox" required /> Silaturahim & Kebersamaan *</label>
                                                </div>
                                            </div>
                                            
                                            <div class="form-group">
                                                <div class="col-md-9">
                                                    <label class="check"><input type="checkbox" id="infoProgram5" name="infoProgram5" class="icheckbox" required /> Penawaran Sponsorship / Donasi *</label>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <!-- <div class="tab-pane" id="tab-keanggotaan">
                                        ...
                                        <div class="panel-body" style="z-index: 2000">
                                            ...
                                            <div class="form-group">
                                                <label class="col-md-5 control-label text-left">Iuran sukarela sebesar : Rp. </label>
                                                <div class="col-md-6">
...
<!-- MODAL HAPUS ANGGOTA -->
<div class="message-box message-box-danger animated zoomIn" data-sound="alert" id="message-box-hapus-anggota">
        ...
        <div class="mb-middle">
            ...
            <form action="<?= base_url('koordinator/Anggota/hapusAnggota'); ?>" class="form-horizontal" method="post">
                <div class="mb-content">
                    <div class="panel-body">
                        <p>Anda yakin akan menghapus anggota IKASMA3BDG dengan identitas Anggota sebagai berikut :</p>
...
<script>
    ...
    $(".btn-ubah-anggota").click(function() {
        ...
        $.get("<?= base_url('koordinator/Anggota/getAnggotaByIds/') ?>"+idAnggota, function(data, success) {
            ...
            // var program4 = data_obj.anggota[0].silaturahim_keberasamaan;
            ...
            // if (program1 == "1") {
            //     document.getElementById('infoProgram1').checked;
            // } else {
            //     document.getElementById('infoProgram1').checked = false;
            // }

            var statusBekerja = data_obj.anggota[0].status_bekerja;
            if (statusBekerja == 0) {
    ...
    $(".btn-hapus-anggota").click(function() {
        ...
        $.get('<?= base_url("koordinator/Anggota/getAnggotaByIds/"); ?>'+idAnggota, function (data) {
