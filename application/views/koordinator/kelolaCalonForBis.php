            ...
            <div class="panel panel-default tabs">
                ...
                <div class="panel-body tab-content">
                    ...
                    <div class="tab-pane" id="tab-second">
                        ...
                        <div class="form-group">
                            <form action="<?= base_url('koordinator/ForumBisnis/setAddForbis'); ?>"
                                class="form-horizontal" id="tambah-forbis-validate" method="post"
        ...
        <div class="message-box animated zoomIn" data-sound="alert" id="message-box-terima">
            ...
            <div class="mb-container">
                <div class="mb-middle">
                    ...
                    <form action="<?= base_url('koordinator/ForumBisnis/aktivasiCalonForBis'); ?>"
        ...
        <div class="message-box message-box-danger animated zoomIn" data-sound="alert" id="message-box-tolak">
            ...
            <div class="mb-container">
                <div class="mb-middle">
                    ...
                    <form action="<?= base_url('koordinator/ForumBisnis/tolakCalonForBis'); ?>" class="form-horizontal"
                        method="post">
                        <div class="mb-content">
                            <div class="panel-body">
